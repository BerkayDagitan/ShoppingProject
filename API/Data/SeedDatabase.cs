...
namespace API.Data
{
    public static class SeedDatabase
    {
        public static async Task InitializeAsync(IApplicationBuilder app)
        {
            ...
            {
                var customer = new AppUser { Name = "Ali Yilmaz", UserName = "aliyilmaz", Email = "aliyilmaz@gmail.com" };
                var admin = new AppUser { Name = "Berkay Dagitan", UserName = "berkaydagitan", Email = "berkaydagitan@gmail.com" };
